...
Vector-leaf models use [JSON predictor format 3](json-predictor-vector.md).
They are outside this scalar-tree profile. The R and JVM readers accept only
versions 1 and 2 and reject vector artifacts before scoring.
