...
BENCHMARK_NAME = "ctboost_0160_full_hpo25"
...
def checkpoint(workspace, artifacts, manifest):
    ...
    archive = artifacts / f"ctboost_0160_full_s{manifest['shard_index']:03d}_raw.tar.gz"
        ...
        while pending or active:
            for slot in range(2):
                ...
                command = [
                    ...
                    "-I",
                    "-B",
                    str(package / "benchmarks/tabarena/hpo_full_0160.py"),
                    "run-parent",
                    "--plan",
...
def main():
    ...
    parser.add_argument(
        "--output-root", type=Path, default=Path("/kaggle/working/ctboost-0160-full")
    )
    parser.add_argument(
    ...
    workspace = Path(tempfile.gettempdir()) / (
        "ctboost-0160-full-" + file_hash(__file__)[:16]
    )
