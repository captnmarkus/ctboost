...
wheel = next((OUTPUT / "dist").glob("ctboost-0.1.61-cp312-cp312-win_amd64.whl"))
...
for case in scout_plan["datasets"]:
    ...
    (OUTPUT / "public-0160-model-compatibility.json").write_text(json.dumps(receipt, indent=2, sort_keys=True) + "\n", encoding="utf-8")
