...
assert native_hash == '3fe462617f2ba45ad1b159b8a6a35808095c441d7e1d2c8d7f1f0aaae139ba65'
wheel = next((OUTPUT / "dist-final").glob("ctboost-0.1.61-cp312-cp312-win_amd64.whl"))
...
for case in scout_plan["datasets"]:
    ...
    (OUTPUT / "public-0160-model-compatibility-final.json").write_text(json.dumps(receipt, indent=2, sort_keys=True) + "\n", encoding="utf-8")
