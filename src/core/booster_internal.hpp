...
bool IsMulticlassObjective(const std::string& normalized_objective); bool IsLambdaMARTObjective(const std::string& normalized_objective); bool IsRankingObjective(const std::string& normalized_objective);
