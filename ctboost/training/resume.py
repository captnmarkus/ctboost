...
def _resume_snapshot_config_signature(*, pool: Pool, **kwargs: Any) -> Dict[str, Any]:
    return {
        ...
        "feature_test": str(kwargs["feature_test"]),
        "feature_test_bins": int(kwargs["feature_test_bins"]),
        "feature_test_adjustment": str(kwargs["feature_test_adjustment"]),
        ...
        "leaf_estimation_backtracking": bool(kwargs.get("leaf_estimation_backtracking", False)),
        "multiclass_leaf_solver": str(kwargs.get("multiclass_leaf_solver", "diagonal")),
        "multiclass_feature_test": str(kwargs.get("multiclass_feature_test", "single")),
...
def _resume_snapshot_state_signature(init_state: Mapping[str, Any], init_model: Any) -> Dict[str, Any]:
    return {
        ...
        "feature_test": str(init_state.get("feature_test", "quadratic")),
        "feature_test_bins": int(init_state.get("feature_test_bins", 8)),
        "feature_test_adjustment": str(init_state.get("feature_test_adjustment", "none")),
        ...
        "leaf_estimation_backtracking": bool(init_state.get("leaf_estimation_backtracking", False)),
        "multiclass_leaf_solver": str(init_state.get("multiclass_leaf_solver", "diagonal")),
        "multiclass_feature_test": str(init_state.get("multiclass_feature_test", "single")),
