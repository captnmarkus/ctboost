...
def export_model(
    ...
    *,
    ...
    if (
        ...
        and not prepared_features
        and resolved_format != "json_predictor"
    ):
        raise ValueError(
            "standalone Python, C++, and ONNX exports currently support numeric or "
            "already-prepared features only; use JSON predictor export to embed the fitted "
            "preprocessing pipeline, or pass prepared_features=True"
        )
